...
#Not very convenient, as it changes the data, and returns it
#but the previous transform also does this
def inplace(f):
    #The function it returns, is the one that calls the function
    def _f(b):
        f(b)
        return b
    return _f
